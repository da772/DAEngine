...

{
	...
	vec2 texcoord1 = v_shadowcoord0.xy/v_shadowcoord0.w;
	vec2 texcoord2 = v_shadowcoord1.xy/v_shadowcoord1.w;
	vec2 texcoord3 = v_shadowcoord2.xy/v_shadowcoord2.w;
	vec2 texcoord4 = v_shadowcoord3.xy/v_shadowcoord3.w;
	...
	if (selection0)
	{
		vec4 shadowcoord = v_shadowcoord0;
	...
	{
		vec4 shadowcoord = v_shadowcoord1;
	...
	{
		vec4 shadowcoord = v_shadowcoord2;
	...
	{
		vec4 shadowcoord = v_shadowcoord3;
