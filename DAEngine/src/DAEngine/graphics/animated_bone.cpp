...
namespace da
{
	...
	int CAnimatedBone::GetScaleIndex(float animationTime)
	{
	...
	float CAnimatedBone::GetScaleFactor(float lastTimeStamp, float nextTimeStamp, float animationTime)
	{
	...
	glm::mat4 CAnimatedBone::InterpolatePosition(float animationTime)
	{
		if (1 == m_NumPositions)
	...
	glm::mat4 CAnimatedBone::InterpolateRotation(float animationTime)
	{
		if (1 == m_NumRotations)
		{
	...
	glm::mat4 CAnimatedBone::InterpolateScaling(float animationTime)
	{
		if (1 == m_NumScalings)
