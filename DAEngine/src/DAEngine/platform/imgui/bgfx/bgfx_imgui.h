...
void imguiBeginFrame(int32_t _mx, int32_t _my, uint8_t _button, int32_t _scrollX, int32_t _scrollY, uint16_t _width, uint16_t _height, int _inputChar = -1, bgfx::ViewId _view = 255);
void imguiEndFrame();
...
#define IMGUI_FLAGS_ALPHA_BLEND UINT8_C(0x01)
	...
	{
		return ImageButton(toId(_handle, _flags, _mip), _size, _uv0, _uv1, -1, _bgCol, _tintCol);
	}
